...
- 지원 형식: IPS, BPS, UPS, PPF, APS, Xdelta. DCP
...
- **2번 영역 클릭**: 패치 파일(IPS, BPS, UPS, PPF, APS, Xdelta, DCP)만 선택 가능
...
1. 원본 파일과 패치 파일을 함께 선택한 뒤, 1번 또는 2번 위치에 드래그 앤 드롭합니다.   
   (원본 파일이 압축(zip, rar, 7z, chd, rvz) 파일 인 경우 자동으로 압축 해제 후 패치를 진행합니다.)
